...
import photoFragmentShader from '~/features/wall/canvas/gallery-canvas/shaders/photo.frag.glsl?raw'
import photoVertexShader from '~/features/wall/canvas/gallery-canvas/shaders/photo.vert.glsl?raw'
