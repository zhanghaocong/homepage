...
import type { GalleryEffectUniforms } from '~/features/wall/canvas/gallery-canvas/galleryMeshRegistry'
import compositePostFragmentShader from '~/features/wall/canvas/gallery-canvas/shaders/compositePost.frag.glsl?raw'
