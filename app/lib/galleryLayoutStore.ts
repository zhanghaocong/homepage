...
let sectionScroll = new Map<number, number>();
let scrollPow = 0;
...
export function syncGalleryLayoutScroll(
	entries: SectionScrollState[],
	power = 0,
) {
	scrollPow = power;
	sectionScroll.clear();
...
export function getFrameWorldRectForSpec(
