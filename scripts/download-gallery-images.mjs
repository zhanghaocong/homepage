...
const allCateImages = JSON.parse(
  await import('node:fs/promises').then((fs) => fs.readFile(join(root, 'app/data/allCateImages.json'), 'utf8')),
)
...
const extraAssets = ['/assets/img/f.jpg.webp', '/assets/img/tag.svg']
