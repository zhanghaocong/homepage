...
const ATLAS_QUALITY = 100
const ATLAS_EFFORT = 6

/** Match `--site-bg` (#fff) — gutter + preview background */
const GUTTER_RGB = { r: 255, g: 255, b: 255 }

const allCateImages = JSON.parse(await readFile(join(root, 'app/data/allCateImages.json'), 'utf8'))
...
await sharp({
  ...
  .webp({ quality: ATLAS_QUALITY, effort: ATLAS_EFFORT })
  .toFile(outImage)
